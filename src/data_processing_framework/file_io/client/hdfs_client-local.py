...
class HDFSClient(BaseIOClient):
    ...
    def __init__(self, namenode_host: str = "localhost", namenode_port: int = 9870, datanode_port: int = 9864, user: str = "hdfs"):
    ...
    def _fix_datanode_url(self, url: str): 
        ...
        # Substituir 0.0.0.0:9864 por localhost:9864
        url = re.sub(r'://0\.0\.0\.0:9864', f'://{self.namenode_host}:{self.datanode_port}', url)
        
        # Substituir qualquer hostname que termine com :9864 por localhost:9864
        url = re.sub(r'://[^:/]+:9864', f'://{self.namenode_host}:{self.datanode_port}', url)
